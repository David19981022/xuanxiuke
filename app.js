...
app.post("/admin/course/change"             ,admin_router.changecourse);        //Ajax的接口，改变课程  修改
...
//退出
app.get("/tuichu",student_router.tuichu);
// 我的已报课程  --页面
app.get("/ke",student_router.ke);
// 获取已报课程数据
app.get("/keList/:cid",student_router.keList);
